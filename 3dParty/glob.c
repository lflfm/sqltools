...
*
*charmatches itself except where char is '*' or '?' or '['
*\charmatches char, including any pattern character
*
* examples:
*a*cac abc abbc ...
*a?cacc abc aXc ...
...
*
* $Log: glob.c,v $
* Revision 1.1  2005/10/19 00:26:03  akochetov
* added glob pattern matching for File Panel filter implementation (not done yet)
*
