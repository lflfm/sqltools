//  File. . . . : test_grin_ptr.cpp
//  Description : grin_ptr<> - Provides support for "Cheshire Cat" idiom
//  Rev . . . . :
//
//  Classes . . : 
//
...
template class arg::grin_ptr<int>;
...
int main()
{
	// Ensure that copying and deleting work
	{
		outer o1;
		...
		ARG_TEST(2 == o2.get_current_instances());
		ARG_TEST(1 == o2.get_copy_count());
		ARG_TEST(0 == o2.get_delete_count());
